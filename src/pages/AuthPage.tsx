...
function AppleLogo() {
  return (
    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M17.05 12.04c-.03-2.62 2.14-3.88 2.24-3.94-1.22-1.79-3.13-2.04-3.81-2.07-1.62-.17-3.17.95-4 .95-.83 0-2.1-.93-3.45-.9-1.78.03-3.42 1.03-4.34 2.62-1.85 3.21-.47 7.95 1.33 10.55.88 1.27 1.93 2.69 3.3 2.64 1.32-.05 1.82-.85 3.42-.85 1.6 0 2.05.85 3.45.83 1.43-.03 2.32-1.29 3.19-2.57 1-1.48 1.42-2.92 1.44-2.99-.03-.01-2.76-1.06-2.79-4.2zM14.6 4.59c.73-.88 1.22-2.11 1.09-3.34-1.05.04-2.33.7-3.09 1.58-.68.78-1.28 2.04-1.12 3.24 1.18.09 2.38-.6 3.12-1.48z" />
    </svg>
  );
}
        ...
        <div className="glass-card rounded-3xl p-8 md:p-10 shadow-2xl">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-full bg-secondary-900 px-5 py-4 text-base font-semibold text-white shadow-lg transition-all hover:bg-secondary-800 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-secondary-900 dark:hover:bg-secondary-100"
            >
              {oauthLoading === 'apple' ? <Loader2 className="h-6 w-6 animate-spin" /> : <AppleLogo />}
              <span>{oauthLoading === 'apple' ? 'Signing in...' : 'Continue with Apple'}</span>
            </button>
            <button
              type="button"
              ...
              className="w-full flex items-center justify-center gap-3 rounded-full bg-secondary-900 px-5 py-4 text-base font-semibold text-white shadow-lg transition-all hover:bg-secondary-800 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white dark:text-secondary-900 dark:hover:bg-secondary-100"
            >
              {oauthLoading === 'google' ? <Loader2 className="h-6 w-6 animate-spin" /> : <GoogleLogo />}
          ...
          <div className="my-7 flex items-center gap-3">
            ...
            <span className="text-xs font-medium uppercase tracking-[0.18em] text-secondary-500">or use email</span>
            <div className="h-px flex-1 bg-secondary-200 dark:bg-secondary-700" />
          </div>
